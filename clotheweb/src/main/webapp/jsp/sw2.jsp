...
<div class="all">
    <div class="c" >
        <div class="sekil"><img height="500" src="womanImages/sw2.PNG">
            <img height="500" src="womanImages/sw2.1.PNG">
        </div>


        <div class="form">
            <div class="form">
                <div class="yazi"><font color="#000000" size="6" face="Centaur"><b>TATE ART COLLECTION LISSITZKY HOODIE</b></font></div><br></br>
                <div class="yazi"><font color="#000000" size="5" face="Centaur"><b>40.00$</b></font></div>
                <div class="yazi"><font color="#000000" size="4" face="Centaur"><b>Product code #000004</b></font></div>
                <div class="yazi"><font color="#000000" size="4" face="Centaur"><b>Tate Art Collection long sleeve hoodie with a Lissitzky illustration and adjustable hood. Made of cotton.</b></font></div>
                <br></br>
                <div class="yazi"><font color="#000000" size="4" face="Centaur"><b>Care for fiber: at least 50% ecologically grown cotton.</b></font></div>
                <div class="size" >
                    <ul>
